...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      <ButtonGroup>
        {/* <Button onClick={() => dispatch(decrementLegacy())} color="error">
          Decrement
        </Button>
        <Button onClick={() => dispatch(incrementLegacy())} color="secondary">
          Increment
        </Button>
        <Button onClick={() => dispatch(incrementLegacy(5))} color="primary">
          Increment by 5
        </Button> */}
